namespace CSF.SRDashboard.Client.Services.Document
{
    ...
    public interface IDocumentService
    {
        ...
        public Task<DocumentInfo> UpdateMetadataForDocument(Guid documentId, string userName, string fileName, string fileContentType, string shortDescription, string submissionMethod, string fileLanguage, List<DocumentTypeDTO> documentTypes, string customMetadata);
    }
}
