namespace CSF.Web.Client
{
    ...
    using CSF.Web.Client.PageValidators;
    using CSF.Web.Client.Services;
    using CSF.Web.Client.Utilities;
    using CSF.Web.Client.Views;
    ...
    using CustomRequestCultureProvider = CSF.Web.Client.Utilities.CustomRequestCultureProvider;
